...
from src.functions.ler_contador_multifuncionais import \
    ler_contador_multifuncionais
from src.functions.ler_contador_zebra import ler_contador_zebra
from src.functions.obter_impressoras_multifuncionais import \
